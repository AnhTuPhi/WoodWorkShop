	...
	<div id="post-wrapped">
		<div class="container">
			<form action="post.php" method="post">
				...
				<tr>
					<td colspan="2" align="center"><input type="submit" name="btn_submit" class="btn_submit" value="Thêm bài viết" style="background:#c89551;color:white;padding:10px 20px;border:none;"></td>
				</tr>
				</table>
			</form>
		</div>
