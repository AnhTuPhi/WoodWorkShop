...
<body>
    ...
    <?php if (isset($_SESSION['username'])): ?>
		<p style="text-align:center;font-size:18px;">Welcom <strong><?php echo $_SESSION['username']; ?></strong></p>
	<?php endif ?>
	<!--<?php if (isset($_SESSION['permision'])): ?>
		<p>Welcom <strong><?php echo $_SESSION['permision']; ?></strong></p>
	<?php endif ?>-->
	<div id="function-wrapped">
		<div class="container">
			<div class="text">
			Là một admin quản trị bạn có thể :
			</div>
			<div class="managerUser" style="margin-left:50px;"><a href="manageUser.php" target="blank">Sửa đổi thông tin User</a></div>
			<div class="post" style="margin-left:50px;"><a href="post.php" target="blank">Post tin tức</a></div>
		</div>
	</div>
